...
/** 对应 FrmYD2001（成品库存管理；子类覆盖 InitP4Columns）：DDH.Winforms.SYD.Forms.FrmYD2001
 *  菜单（共 5 个，cQueryString={StoreCodes,Actions,CTarStoreCodes}）：成品库存管理 YD2000 / 精整区库存管理 YD2040 /
 *    棒材成品库管理 YD2001 / 线材成品库管理 YD2001 / 带钢成品库管理 YD2001
 ...
 *  列集偏差：原 InitP4Columns 只显示成品子集，web 侧按 UCStorage 全量 127 列呈现（可右键列面板收起），
