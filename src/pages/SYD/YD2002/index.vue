...
/** 对应 FrmYD2002（原料/在制品库存管理；子类覆盖 InitSlabColumns）：DDH.Winforms.SYD.Forms.FrmYD2002
 *  菜单（共 5 个，cQueryString={StoreCodes,Actions,CTarStoreCodes}）：在制品库存管理 YD2030 / 板坯库内材料管理 YD2000 /
 *    棒材原料库管理 YD2002 / 线材原料库管理 YD2002 / 带钢原料库管理 YD2002
 ...
 *  列集偏差：原 InitSlabColumns 只显示板坯子集，web 侧按 UCStorage 全量 127 列呈现（可右键列面板收起），
