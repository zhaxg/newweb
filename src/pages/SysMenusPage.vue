...
<template>
  <div class="flex min-h-0 flex-1 flex-col">
    ...
    <div class="flex h-9 shrink-0 items-center gap-1 border-b border-border/60 px-2">
      ...
      <Button text size="small" class="shrink-0 whitespace-nowrap" @click="onAddSibling" label="添加同级">
        <template #icon>
          <GitCommitVertical class="h-3.5 w-3.5" />
        </template>
      </Button>
      <Button text size="small" class="shrink-0 whitespace-nowrap" @click="onAddChild" label="添加子级">
        <template #icon>
          <Network class="h-3.5 w-3.5" />
        </template>
      </Button>
      <Button text size="small" class="shrink-0 whitespace-nowrap" @click="onCopy" label="复制">
        <template #icon>
      ...
      <Button text size="small" class="shrink-0 whitespace-nowrap" @click="onBtnList" label="子级功能点">
        <template #icon>
          <MousePointerClick class="h-3.5 w-3.5" />
        </template>
      </Button>
      <Button text size="small" class="shrink-0 whitespace-nowrap" @click="onExpandAll" label="展开">
        <template #icon>
          <ChevronDown class="h-3.5 w-3.5" />
        </template>
      </Button>
      <Button text size="small" class="shrink-0 whitespace-nowrap" @click="onCollapseAll" label="折叠">
        <template #icon>
...
<style scoped>
.erp-ag-grid :deep(.resc-group-expander) {
  display: inline-flex;
  width: 20px;
  height: 20px;
  flex-shrink: 0;
...
.erp-ag-grid :deep(.resc-group-expander:hover) {
