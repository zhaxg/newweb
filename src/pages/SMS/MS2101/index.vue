...
/** 对应 FrmMS2101（一炼钢炉次撤销记录）：DDH.Winforms.SMS.Forms.FrmMS2101
 *  画面迁移，逻辑不迁移到 */
...
const colDefs = ref<ColDef[]>(([
      { field: 'CLineDesc', headerName: '产线描述', width: 120 },
      { field: 'CMachineDesc', headerName: '机台描述', width: 95 },
      { field: 'CPono', headerName: 'PONO', width: 83 },
      { field: 'CStoveNo', headerName: '炉号', width: 120 },
      { field: 'CReason', headerName: '强制原因', width: 200 },
