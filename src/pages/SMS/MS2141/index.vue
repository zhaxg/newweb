...
/** 对应 FrmMS2141（连铸产出，多菜单共享 cQueryString={LineCode,MachineCode}）：DDH.Winforms.SMS.Forms.FrmMS2141
 *  已接入：publicKVApi.getMSLZLiu（流号下拉）
...
{ field: "Selected", headerName: "选择", width: 64 },
      ...
      { field: "CPrintCode", headerName: "喷号", width: 64, hide: true },
]));
