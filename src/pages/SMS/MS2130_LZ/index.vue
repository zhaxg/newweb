...
/** 对应 FrmMS2130_LZ（连铸作业，多菜单共享 cQueryString={LineCode,MachineCode}）：DDH.Winforms.SMS.Forms.FrmMS2130_LZ
 *  已接入：frmMS2130LZFullApi.queryRoutePlans / checkStoveArrived+stoveArrived / checkCancelStoveArrived+cancelStoveArrived / checkStoveLeave+stoveLeave / getTms2014CCMData+saveTms2014CCMData / frmMS2100XMessageApi.checkIsNeedShowDialog / uCGYYDApi.getGYYDInfo / uCCustomPLCPointShowInfoApi.query / setTextEditShow（拉速标签动态显示）
 *  分栏：上=炉次计划+后序明细/成分 | 工艺要点；下=生产实绩 | 机台实时（无投料 UC）；stackPanel2 出站/取消出站
 *  待接入：二级弹窗占位（班次 FrmMS2100_X_ShiftInfo_1、机台工位、异常信息编辑窗、取消出钢 FrmMS2100_X_CancelLeave、到站工位选择）；
 *          成分信息 publicQMInfo.getGHGSQMInfo swagger 未生成 */
...
const autoRefreshCcm = ref(false);
...
const formFields = [
  ...
  { k: "cUserNameLuzhang", t: "炉长姓名" },
  { k: "cUserIdYicaoshou", t: "一操手id" },
  { k: "cUserNameYicaoshou", t: "一操手姓名" },
  { k: "cPotType", t: "钢包类型" },
  { k: "cPotNo", t: "钢包号" },
  { k: "cPotNoId", t: "钢包唯一标识" },
  { k: "cPotAge", t: "钢包龄", m: "i" },
  { k: "cPotState", t: "包况" },
  { k: "dZb", t: "座包时间", m: "d" },
  { k: "cTimekjsj", t: "开浇时间", m: "d" },
  { k: "cTimetjsj", t: "停浇时间", m: "d" },
  { k: "nTimePro", t: "浇注时间" },
  { k: "dDb", t: "吊包时间", m: "d" },
  { k: "cTempDbdt", t: "到台温度" },
  { k: "nDbdtzl", t: "大包到台重量" },
  ...
  { k: "nJzzl", t: "浇注重量" },
  { k: "cZbh1", t: "中包号1" },
  { k: "cZbh1Id", t: "中包号1唯一标识" },
  { k: "cZbh2", t: "中包号2" },
  { k: "cZbh2Id", t: "中包号2唯一标识" },
  { k: "cZbhkwd1", t: "中包烘烤温度1" },
  { k: "cZbhkwd2", t: "中包烘烤温度2" },
  { k: "cZbqzcj1", t: "中包砌砖厂家1" },
  { k: "cZbqzcj2", t: "中包砌砖厂家2" },
  { k: "cZjbwddc1", t: "左中间包温度" },
  { k: "cZjbwddc2", t: "右中间包温度" },
  { k: "cZjbwdlc1", t: "左中间包温度" },
  { k: "cZjbwdlc2", t: "右中间包温度" },
  { k: "cZjbgrd", t: "中包过热度" },
  { k: "cYxwd", t: "液相温度" },
  { k: "cZbzl1", t: "中包重量1", m: "g" },
  { k: "cZbzl2", t: "中包重量2", m: "g" },
  { k: "cGsInType", t: "钢水到站方式" },
  { k: "cBegLzType", t: "开始浇铸方式" },
  { k: "cEndLzType", t: "连铸浇铸方式" },
  { k: "cGsOutType", t: "钢水离站方式" },
  { k: "cLasu3", t: "1流拉速3" },
  { k: "cLasu4", t: "1流拉速4" },
  { k: "cLasu5", t: "2流拉速1" },
  { k: "cLasu6", t: "2流拉速2" },
  ...
  { k: "cLjjqh8", t: "8流结晶器号" },
  { k: "cLjjqh9", t: "9流结晶器号" },
  { k: "cLtgsm1", t: "1流铜管寿命", m: "i" },
  { k: "cLtgsm2", t: "2流铜管寿命", m: "i" },
  { k: "cLtgsm3", t: "3流铜管寿命", m: "i" },
  { k: "cLtgsm4", t: "4流铜管寿命", m: "i" },
  { k: "cLtgsm5", t: "5流铜管寿命", m: "i" },
  { k: "cLtgsm6", t: "6流铜管寿命", m: "i" },
  { k: "cLtgsm7", t: "7流铜管寿命", m: "i" },
  { k: "cLtgsm8", t: "8流铜管寿命", m: "i" },
  { k: "cLtgsm9", t: "9流铜管寿命", m: "i" },
  { k: "cLksjs1", t: "1流开浇时间", m: "d" },
  { k: "cLksjs2", t: "2流开浇时间", m: "d" },
  { k: "cLksjs3", t: "3流开浇时间", m: "d" },
  { k: "cLksjs4", t: "4流开浇时间", m: "d" },
  { k: "cLksjs5", t: "5流开浇时间", m: "d" },
  { k: "cLksjs6", t: "6流开浇时间", m: "d" },
  { k: "cLksjs7", t: "7流开浇时间", m: "d" },
  { k: "cLksjs8", t: "8流开浇时间", m: "d" },
  { k: "cLksjs9", t: "9流开浇时间", m: "d" },
  { k: "cLtjsj1", t: "1流停浇时间", m: "d" },
  { k: "cLtjsj2", t: "2流停浇时间", m: "d" },
  { k: "cLtjsj3", t: "3流停浇时间", m: "d" },
  { k: "cLtjsj4", t: "4流停浇时间", m: "d" },
  { k: "cLtjsj5", t: "5流停浇时间", m: "d" },
  { k: "cLtjsj6", t: "6流停浇时间", m: "d" },
  { k: "cLtjsj7", t: "7流停浇时间", m: "d" },
  { k: "cLtjsj8", t: "8流停浇时间", m: "d" },
  { k: "cLtjsj9", t: "9流停浇时间", m: "d" },
  ...
  { k: "cDbzk1", t: "大包自开滑板状态", m: "s" },
  { k: "cBackup", t: "备注", m: "m" },
  { k: "cTempCcmGet", t: "铸机索要温度℃" },
  { k: "nRemaining", t: "浇余(吨)", m: "g" },
  { k: "cZjbwdzc1", t: "中包温度1" },
  { k: "cZjbwdzc2", t: "中包温度2" },
  { k: "cZjbwdzc3", t: "中包温度3" },
  { k: "cZjbwdzc4", t: "中包温度4" },
  ...
  { k: "cJrssk", t: "浸入式水口" },
  { k: "cCsk", t: "长水口" },
  { k: "cLasu1", t: "1流拉速1", m: "g" },
  { k: "cLasu2", t: "1流拉速2", m: "g" },
  { k: "cDbzk", t: "是否自开", m: "s" },
...
async function onQuery(mandatory = true) {
  ...
  querying.value = true;
  try {
    plans.value = (await frmMS2130LZFullApi.queryRoutePlans(dto)) ?? [];
...
async function onArrival() {
  ...
  if (!row) return;
  try {
    await frmMS2130LZFullApi.checkStoveArrived(tms2010Of(row));
    ...
    if (!window.confirm(`确定对炉次号为‘${row.tms2000_cStove}’的炉次执行炉次到站操作？`)) return;
    await frmMS2130LZFullApi.stoveArrived({ tms2010: tms2010Of(row), shiftInfoDto: null, operationModeEnum: "Custom" });
    await onQuery(true);
    await showLastProcException();
...
async function onArrivalCancel() {
  ...
  if (!row) return;
  try {
    await frmMS2130LZFullApi.checkCancelStoveArrived(tms2010Of(row));
...
async function onBeg() {
  ...
  if (!row) return;
  try {
    await frmMS2130LZFullApi.checkStoveProBeg(tms2010Of(row));
    if (!window.confirm(`确定对炉次号为‘${row.tms2000_cStove}’的炉次执行开始浇铸操作？`)) return;
...
async function onBegCancel() {
  ...
  if (!row) return;
  try {
    await frmMS2130LZFullApi.checkCancelStoveProBeg(tms2010Of(row));
    if (!window.confirm(`确定对炉次号为‘${row.tms2000_cStove}’的炉次执行取消开始浇铸操作？`)) return;
...
async function onEnd() {
  ...
  if (!row) return;
  try {
    await frmMS2130LZFullApi.checkStoveProEnd(tms2010Of(row));
    if (!window.confirm(`确定对炉次号为‘${row.tms2000_cStove}’的炉次执行浇铸结束操作？`)) return;
...
async function onEndCancel() {
  ...
  if (!row) return;
  try {
    await frmMS2130LZFullApi.checkCancelStoveProEnd(tms2010Of(row));
    if (!window.confirm(`确定对炉次号为‘${row.tms2000_cStove}’的炉次执行取消时浇铸结束操作？`)) return;
...
<template>
  <div class="flex min-h-0 flex-1 flex-col">
    <div class="flex h-9 shrink-0 items-center gap-1 overflow-x-auto border-b border-border/60 px-2">
      ...
      <Button text class="shrink-0 whitespace-nowrap" @click="onBegCancel">取消开始</Button>
      <Button text class="shrink-0 whitespace-nowrap" @click="onEnd">浇铸结束</Button>
      <Button text class="shrink-0 whitespace-nowrap" @click="onEndCancel">取消结束</Button>
    ...
    <Splitter layout="vertical" class="min-h-0 flex-1">
      ...
      <SplitterPanel :size="50" :minSize="25" class="min-h-0 overflow-hidden">
        <Splitter layout="horizontal" class="h-full min-h-0">
          ...
          <SplitterPanel :size="30" :minSize="12" class="flex min-h-0 flex-col overflow-hidden">
            <div class="flex h-8 shrink-0 items-center border-b border-border/60 px-2">
