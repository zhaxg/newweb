...
const colDefs: ColDef[] = [
      ...
      { field: "CStdCode", headerName: "CStdCode", width: 120 },
      { field: "CSgStd", headerName: "CSgStd", width: 120 },
      { field: "CRemark", headerName: "CRemark", width: 120 },
      { field: "CStdCodeOld", headerName: "CStdCodeOld", width: 120 },
...
<template>
  <div class="flex min-h-0 flex-1 flex-col">
    ...
    <div class="flex h-9 shrink-0 items-center gap-1 border-b border-border/60 px-2">
      ...
      <span class="ml-auto text-xs text-muted-foreground">标准维护（{{ rows.length }}）</span>
    </div>
