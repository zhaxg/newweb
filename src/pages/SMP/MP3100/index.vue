        ...
        <TabPanel value="plan" class="flex h-full min-h-0 flex-col overflow-hidden">
          ...
          <div class="grid shrink-0 grid-cols-6 items-center gap-x-3 gap-y-1.5 border-b border-border/60 px-3 py-2">
            <div class="col-span-2 flex min-w-0 items-center gap-1.5">
              ...
              <DatePicker v-model="q1.dates" selection-mode="range" :manual-input="false" date-format="yy-mm-dd"
            ...
            <SplitterPanel :size="42" :minSize="20" class="flex flex-col overflow-hidden">
              <div class="min-h-0 flex-1 overflow-hidden">
                <AgGridVue class="hmx-ag-grid h-full w-full" :theme="theme" :locale-text="AG_GRID_LOCALE_CN"
                  :pagination="false" :default-col-def="hmxDefaultColDef" :column-defs="mainColDefs" :row-data="rows1"
                  :loading="querying1" @grid-ready="onReady1" @cell-focused="onCellFocused"
        ...
        <TabPanel value="cpt" class="flex h-full min-h-0 flex-col overflow-hidden">
          ...
          <div class="grid shrink-0 grid-cols-6 items-center gap-x-3 gap-y-1.5 border-b border-border/60 px-3 py-2">
            <div class="col-span-2 flex min-w-0 items-center gap-1.5">
              ...
              <DatePicker v-model="q2.dates" selection-mode="range" :manual-input="false" date-format="yy-mm-dd"
            ...
            <div class="flex min-w-0 items-center gap-1.5">
              ...
              <Select v-model="q2.planStatus" :options="planStatusOptions" option-label="label" option-value="value"
          ...
          <div class="min-h-0 flex-1 overflow-hidden">
            <AgGridVue class="hmx-ag-grid h-full w-full" :theme="theme" :locale-text="AG_GRID_LOCALE_CN"
              :pagination="false" :default-col-def="hmxDefaultColDef" :column-defs="cptColDefs" :row-data="rows2"
              :loading="querying2" @grid-ready="onReady2" @first-data-rendered="autoSizeOnFirstData" />
          </div>
        </TabPanel>
      </TabPanels>
    </Tabs>
