...
<template>
  <div class="flex min-h-0 flex-1 flex-col">
    ...
    <div class="flex h-9 shrink-0 items-center gap-1 border-b border-border/60 px-2">
      ...
      <Button text size="small" class="shrink-0 whitespace-nowrap" @click="onbtnAudit"><IconCheck class="h-3.5 w-3.5" />审核</Button>
      <Button text size="small" class="shrink-0 whitespace-nowrap" @click="onbtnCancelAudit"><IconX class="h-3.5 w-3.5" />取消审核</Button>
