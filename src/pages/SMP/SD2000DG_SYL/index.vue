...
/** 对应 FrmSD2000DG_SYL（带钢钢坯提料）：DDH.Winforms.SMP.Forms.FrmSD2000DG_SYL
 *  画面迁移，逻辑不迁移到 */
...
<template>
  <div class="flex h-full flex-col gap-2 p-2">
    ...
    <div class="flex items-center justify-between rounded bg-white p-2 shadow-sm dark:bg-gray-900">
      ...
      <Button label="批量导入订单" severity="secondary" @click="onbtnImport" />
      <Button label="删除" severity="danger" @click="onbtnDelete" />
      <Button label="质量设计" severity="secondary" @click="onbtnQualityDesign" />
      </div>
    </div>
