...
<template>
  <div class="flex min-h-0 flex-1 flex-col">
    <div class="flex h-9 shrink-0 items-center gap-1 border-b border-border/60 px-2">
      ...
      <Button text severity="danger" class="shrink-0 whitespace-nowrap" @click="onBtn2"
        ><IconTrash class="h-3 w-3" />删除取样实绩</Button
      >
      <Button text class="shrink-0 whitespace-nowrap" @click="onBtn3"
        ><IconSearch class="h-3 w-3" />生成新代表样</Button
      >
      <Button text severity="danger" class="shrink-0 whitespace-nowrap" @click="onBtn4"
        ><IconX class="h-3 w-3" />取消新代表样号</Button
      >
      <Button text class="shrink-0 whitespace-nowrap" @click="onBtn5"><IconSearch class="h-3 w-3" />重组样</Button>
      <Button text severity="danger" class="shrink-0 whitespace-nowrap" @click="onBtn6"
        ><IconX class="h-3 w-3" />取消重组样</Button
      >
    </div>
