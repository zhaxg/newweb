 ...
 *  行内「月度报表」「年度报表」是站内跳转 → /carbon/reduction/{monthReport,yearReport}
 *
...
const spec: ListPageSpec = {
  ...
  columns,
  actions: [
    { label: "减排项目月报", kind: "link", to: "/carbon/reduction/monthReport" },
    { label: "减排项目年报", kind: "link", to: "/carbon/reduction/yearReport" },
  ],
  summary: ({ rows }) => {
