...
/** 对应 FrmTableView（通用表格查看）：Hmx.WinForms.Widgets.TableConfig.FrmTableView
 *  画面迁移，逻辑不迁移到
 *  2026-09-22 已完成精修 */
...
import { IconCheck, IconDeviceFloppy, IconPlus, IconSearch, IconTrash } from "@tabler/icons-vue";
...
<template>
  <div class="flex min-h-0 flex-1 flex-col">
    ...
    <div class="flex h-9 shrink-0 items-center gap-1 border-b border-border/60 px-2">
      ...
      <Button text class="shrink-0 whitespace-nowrap" @click="onSelect"> <IconCheck class="h-3 w-3" />选择 </Button>
      <span class="ml-auto text-xs text-muted-foreground">通用表格（{{ rows.length }}）</span>
    </div>
