...
/** 对应 FrmSS3020（出炉实绩）：DDH.Winforms.SHR.Forms.StripSteel.FrmSS3020
 *  已接入：e1000Api.queryTiE3020List
 *  待接入：无
...
import { e1000Api, type TiE3020, type TimeRange } from "@/api/mes4ddh/shr.swagger";

const theme = makeHmxGridTheme();
const rows = ref<TiE3020[]>([]);
...
const colDefs: ColDef[] = [
  ...
  { field: "fueRow", headerName: "炉列", width: 112 },
  { field: "plantCode", headerName: "机组代码", width: 112 },
  { field: "extractTime", headerName: "出炉时刻", width: 112 },
  { field: "inFurTime", headerName: "在炉时间", width: 112 },
  { field: "extractTemp", headerName: "出炉温度", width: 112 },
...
async function onQuery() {
  ...
  try {
    rows.value =
      (await e1000Api.queryTiE3020List({
