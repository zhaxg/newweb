...
/** 对应 FrmSS3000（板坯照合实绩）：DDH.Winforms.SHR.Forms.StripSteel.FrmSS3000
 *  已接入：e1000Api.queryTiE3000List
 *  待接入：无
...
import { e1000Api, type TiE3000, type TimeRange } from "@/api/mes4ddh/shr.swagger";

const theme = makeHmxGridTheme();
const rows = ref<TiE3000[]>([]);
...
const colDefs: ColDef[] = [
  ...
  { field: "slabNo", headerName: "照合的板坯号", width: 138 },
  { field: "plantCode", headerName: "机组代码", width: 112 },
  { field: "measWidth", headerName: "实测板坯宽度", width: 138 },
  { field: "measLength", headerName: "实测板坯长度", width: 138 },
  { field: "measWeight", headerName: "实测板坯重量", width: 138 },
  { field: "measTemp", headerName: "实测板坯温度", width: 138 },
  { field: "furNo", headerName: "分配加热炉号", width: 138 },
  { field: "furRow", headerName: "分配加热炉列", width: 138 },
  { field: "autoCheckFlag", headerName: "自动照合标记", width: 138 },
  { field: "checkTime", headerName: "照合时间", width: 112 },
...
async function onQuery() {
  ...
  try {
    rows.value =
      (await e1000Api.queryTiE3000List({
