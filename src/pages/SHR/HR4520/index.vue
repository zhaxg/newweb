...
const colDefs = ref<ColDef[]>(([
      ...
      { field: 'NSlabDlQua', headerName: '堆冷坑支数', width: 112 },
      { field: 'NSlabDlWgt', headerName: '堆冷坑重量', width: 112 },
      ...
      { field: 'NSlabDlHqQua', headerName: '去火切数量', width: 112 },
      { field: 'NSlabDlHqWgt', headerName: '去火切重量', width: 112 },
