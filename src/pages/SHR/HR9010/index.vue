...
/** 对应 FrmHR9010（上辊道实绩）：DDH.Winforms.SHR.Forms.FrmHR9010
 *  已接入：hR4200Api.queryTiL2me04s
 *  偏差：无 */
...
import { hR4200Api, type DtoQueryL2, type TiL2me04, type TimeRange } from "@/api/mes4ddh/shr.swagger";
...
/* ---------- 表格（gridView1 / TiL2me04） ---------- */
const rows = shallowRef<TiL2me04[]>([]);
...
async function query() {
  ...
  try {
    ...
    rows.value = (await hR4200Api.queryTiL2me04s(dto)) ?? [];
