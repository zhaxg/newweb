...
const colDefs = ref<ColDef[]>(([
      ...
      { field: 'CCoolMode', headerName: '冷却模式', width: 112 },
      ...
      { field: 'NKLQua', headerName: '块数', width: 112 },
      { field: 'NKLRate', headerName: '比例', width: 112 },
      { field: 'NSLQua', headerName: '块数', width: 112 },
      { field: 'NSLRate', headerName: '比例', width: 112 },
      { field: 'NDQQua', headerName: '块数', width: 112 },
      { field: 'NDQRate', headerName: '比例', width: 112 },
