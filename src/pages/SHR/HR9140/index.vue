 ...
 *  已接入：hR4200Api.queryTiL2me06s
 *  偏差：打印为占位（原 XtraReportPrinter 报表模板未在 web 侧接入）；nFurStatus 下拉仅 入炉/出炉（同原窗体 Load，默认不选）；KV 列显示原值 */
...
const input = reactive({
  slabNo: "",
  cBatchOrder: "",
  nFurStatus: null as Thr3010FurStatusEnum | null,
  dates: monthRange() as Date[] | null,
});

/* ---------- 表格（gridView1 / TiL2ME06ItemDto） ---------- */
...
const colDefs: ColDef[] = [
  ...
  { colId: "nFurType", field: "nFurType", headerName: "装炉方式", width: 149 },
  ...
  { colId: "cSgCode", field: "cSgCode", headerName: "钢种", width: 149 },
  ...
  { colId: "cDn", field: "cDn", headerName: "需要堆冷", width: 149 },
  ...
  { colId: "nThickMin", field: "nThickMin", headerName: "厚度下限", width: 149 },
  { colId: "nThickMax", field: "nThickMax", headerName: "厚度上限", width: 149 },
...
async function query() {
  ...
  try {
    ...
    rows.value = (await hR4200Api.queryTiL2me06s(dto)) ?? [];
...
function btnPrint() {
  ...
  const selected = api.value?.getSelectedRows() as TiL2ME06ItemDto[] | undefined;
