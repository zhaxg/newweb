...
import { hR9000Api, type DtoQueryL2, type TiL2me09Dto, type TimeRange } from "@/api/mes4ddh/shr.swagger";
...
/* ---------- 表格（gridView1 / TiL2me09Dto） ---------- */
const rows = shallowRef<TiL2me09Dto[]>([]);
...
async function query() {
  ...
  try {
    ...
    rows.value = (await hR9000Api.queryTiL2me09s(dto)) ?? [];
