...
const colDefs = ref<ColDef[]>(([
      ...
      { field: 'AirConsumption', headerName: '压缩空气累计消耗', width: 112 },
      { field: 'ExternalWaterConsumption', headerName: '外网水累计消耗料', width: 112 },
      { field: 'GroundWaterConsumption', headerName: '深井水累计消耗料', width: 112 },
      { field: 'O2Consumption', headerName: '氧气累计消耗', width: 112 },
