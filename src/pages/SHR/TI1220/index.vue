...
const colDefs = ref<ColDef[]>(([
      ...
      { field: 'NWidthSj', headerName: '成品宽度', width: 112 },
      { field: 'NThick', headerName: '厚度', width: 112 },
      { field: 'NWidth', headerName: '宽度', width: 112 },
      { field: 'NLen', headerName: '长度', width: 112 },
      { field: 'NPlanWidthMin', headerName: '目标宽度下限(内控)', width: 112 },
      { field: 'NPlanWidthMax', headerName: '目标宽度上限(内控)', width: 112 },
      { field: 'NWidthTol', headerName: '宽度公差', width: 112 },
